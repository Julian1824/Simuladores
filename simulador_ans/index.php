            ...
            <form>
                ...
                <div>
                    ...
                    <TABLE class="table align-middle" BORDER WIDTH="50%">
                        ...
                        <TBODY>
                            <TR>
                                <TH class="text-center" colspan="3" style="color: #FFFFFF; background: #ABABAB"
                                    id="cambio1">
                    ...
                    <TABLE class="table align-middle" BORDER WIDTH="50%">
                        ...
                        <THEAD>
                            <TR>
                                <TH class="text-center" colspan="3" style="color: #FFFFFF; background: #000000">Cancelación
                                    total</TH>
                            </TR>
                        </THEAD>
                        ...
                        <TR>
                            <TD class="text-center" colspan="3">Si es cancelación programarlo en el apolo de cancelación y
                                suspensión </TD>
                        </TR>
                        <TBODY>
                            <TR>
                        ...
                        <TBODY>
                            <TR>
                                <TH class="text-center" colspan=3 style="color: #FFFFFF; background: #ABABAB" id="cambio7">
                                </TH>
                            </TR>
                        </TBODY>
